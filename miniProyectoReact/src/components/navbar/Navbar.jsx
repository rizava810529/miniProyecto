        ...
        <div className="container-fluid">
          ...
          <form className="d-flex" role="search">
            ...
            <Modal
              ...
              dialogClassName="modal-top modal-fullscreen tamaño modalLocation"
            >
              <Modal.Header closeButton>
                <Modal.Title className="typography">
                  Edit your search
                </Modal.Title>
              </Modal.Header>
              <Modal.Body>
            ...
            <Modal
              ...
              onHide={handleCloseGuestsModal}
              dialogClassName="modal-top modal-fullscreen tamaño modalGuest"
            >
              <Modal.Header closeButton>
            ...
            <button className="btn white" type="submit">
              <img src={busqueda} className="img-fluid" alt="Logo" />
            </button>
          </form>
        </div>
      </nav>
